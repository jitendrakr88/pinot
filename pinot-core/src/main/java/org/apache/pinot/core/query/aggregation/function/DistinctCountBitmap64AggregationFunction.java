...
public class DistinctCountBitmap64AggregationFunction
    extends BaseSingleInputAggregationFunction<Roaring64Bitmap, Long> {
   ...
   * expression.
   */
  private static Roaring64Bitmap convertToValueBitmap(
      DistinctCountBitmap64AggregationFunction.DictIdsWrapper dictIdsWrapper) {
