...
/**
 * The {@code DistinctCountBitmap64MVAggregationFunction} calculates the number of distinct values for a given
 * multi-value expression using Roaring64Bitmap. The bitmap stores the actual values for {@code INT} expression, or
