...
public enum AggregationFunctionType {
  ...
  DISTINCTCOUNTBITMAP("distinctCountBitmap", ReturnTypes.BIGINT, OperandTypes.ANY, SqlTypeName.OTHER,
      SqlTypeName.INTEGER),
  DISTINCTCOUNTBITMAP64("distinctCountBitmap64", ReturnTypes.BIGINT, OperandTypes.ANY, SqlTypeName.OTHER,
      SqlTypeName.BIGINT),
  DISTINCTCOUNTBITMAP64MV("distinctCountBitmap64MV", ReturnTypes.BIGINT, OperandTypes.ANY, SqlTypeName.OTHER,
      SqlTypeName.BIGINT),
